...
Status: **NOT_RUN** (attempt 2026-09-11: **BLOCKED**, plant absent on the execution host; see the last section). Needs the m5-ver3 plant (gz-sim 8.11, `forklift_ver3`
...
- `python3 m8/bench/e1_pocket.py` → prints `NOT_RUN`, exit 2 (unchanged stub).
