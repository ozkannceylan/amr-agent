...
function. No ROS lives here. Phase 2b registers `approve` on
`fleet_cli` (implementation stays in `console/approve.py`). Phase 4
is the live plant.
...
python3 m6/fleet/fleet_cli.py approve list
python3 m6/fleet/fleet_cli.py approve approve <id>
./m7.sh stop
```
