...
Usage (after sourcing /opt/ros/jazzy/setup.bash; WSLg provides DISPLAY):
  python3 m5_ver2/step4/ros2/hmi_node.py
"""
...
def encoder_lamp(healthy):
    ...
    IT READS THE TRUE CHANNELS. A fault injected in step4.py corrupts
    ...
    broken. README_step4.md says so.
    """
    if healthy is True:
...
class Hmi(Node):
    ...
    def __init__(self, root):
        ...
        self.root = root
        root.title("Step 4 - forklift teleoperation")
