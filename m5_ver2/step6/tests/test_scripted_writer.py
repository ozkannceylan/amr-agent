...
WHAT THESE PROVE AND WHAT THEY DO NOT
  scripted_writer runs the REAL step6.control_loop; that loop already has
  its own evidence in test_step6_virtual_loop.py and nothing here repeats
...
def _rig():
    """The two dicts step6.main() builds, at their start-up values."""
