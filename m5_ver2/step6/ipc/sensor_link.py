...
# leaving and arrives at step6.py looking FRESH. At rest that pair is
# 0/0, which step6.py and the design both name the most dangerous lie
...
class SensorLink(Node):
    ...
    def cb_fields(self, msg):
        ...
        # step6.py's own timeout then writes the trip values for both.
