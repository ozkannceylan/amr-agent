...
`step6.py --virtual` swaps the PLCSIM Advanced API object for an instance
...
WHY THE SCAN RUNS ON ReadBool("Motor") AND NOT ON EVERY WRITE
  ...
  fault on exactly that in-between picture. step6.py reads Motor once
...
class VirtualFPLC:
    """Duck-types the five PLCSIM API methods step6.py uses."""
