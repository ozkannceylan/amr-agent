...
Usage (after sourcing /opt/ros/jazzy/setup.bash; WSLg provides DISPLAY):
  python3 m5_ver2/step3/ros2/hmi_node.py
"""
...
def encoder_lamp(healthy):
    ...
    IT READS THE TRUE CHANNELS. A fault injected in step3.py corrupts
    ...
    broken. README_step3.md says so.
    """
    if healthy is True:
...
class Hmi(Node):
    ...
    def __init__(self, root):
        ...
        self.root = root
        root.title("Step 3 - forklift teleoperation")
