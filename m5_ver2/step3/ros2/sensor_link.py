...
Windows over UDP 5101, where step3.py writes PF_OSSD and WF_Clear.
...
def payload(fields_json, encoders_json):
    ...
    ONE DATAGRAM CARRIES BOTH so step3.py has one staleness rule rather
