"""step2.py's pure functions. Nothing here opens the PLCSIM API."""
import json
...
def test_resolve_udp_target_honours_an_explicit_string():
    assert step2.resolve_udp_target("10.0.0.5") == "10.0.0.5"
...
def test_resolve_udp_target_takes_the_first_token_of_the_wsl_reply():
    ...
    assert step2._first_token("172.19.180.72 172.17.0.1 \n") == "172.19.180.72"
