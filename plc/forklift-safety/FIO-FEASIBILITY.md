...
| Record | Value | Date |
|---|---|---|
| Working project archived as | `________` | `________` |
| Probe copy project name | `________` | `________` |
| PLCSIM Advanced instance used for the probe | `________` | `________` |
...
|---|---|---|---|
| PLCSIM Advanced version (control panel) | `________` | `________` | `________` |
| PLCSIM Advanced version (installed programs) | `________` | `________` | `________` |
| Project safety system version | `________` | Safety Administration → Settings | `________` |
| CPU firmware version | `________` | `________` | `________` |
| TIA Portal version + update | `________` | Help → Installed software | `________` |
...
| Record | Value | Date |
|---|---|---|
| Safety-system-version change offered? | `________` | `________` |
| Versions offered by the dialog | `________` | `________` |
| Version selected, or refusal text verbatim | `________` | `________` |
| F0–F6 re-run on the copy after the change | `________` | `________` |
...
|---|---|---|
| Head module placed (name, order number, FW) | `________` | `________` |
| F-DI placed (name, order number, FW) | `________` | `________` |
| F-DI input address range | `________` | `________` |
| Value status enabled, and its address bits | `________` | `________` |
| `F_dest_add` / F-source address | `________` | `________` |
| F-I/O F-monitoring time | `________` | `________` |
| **F-I/O data block name, exactly as generated** | `________` | `________` |
| Channel tag names in the PLC tag table, exactly | `________` | `________` |
| `_1` suffix sweep result | `________` | `________` |
| Compile: errors / warnings | `________` | `________` |
| Download: diff circles solid green? | `________` | `________` |
| F-collective signature online / offline | `________` | `________` |
| CPU operating state | `________` | `________` |
| Safety mode | `________` | `________` |
| F-runtime group executing? | `________` | `________` |
...
|---|---|---|---|
| Channel value(s) | `________` | `________` | `________` |
| Value status bit(s) | `________` | `________` | `________` |
| `PASS_OUT` | `________` | `________` | `________` |
| `QBAD` | `________` | `________` | `________` |
| `QBAD_I_*` (per channel) | `________` | `________` | `________` |
| `ACK_NEC` / `ACK_REI` | `________` | `________` | `________` |
| `DIAG` | `________` | `________` | `________` |
| Diagnostic buffer entries, verbatim | `________` | `________` | `________` |
...
| Item | What the tool printed | Date |
|---|---|---|
| API assembly path and version | `________` | `________` |
| Runtime-manager / interface calls actually used | `________` | `________` |
| Tag-list update call and its options | `________` | `________` |
| **F-DI channel present in the tag list?** | `________` | `________` |
| **Exact tag string, verbatim** | `________` | `________` |
| F-I/O data block present in the tag list? | `________` | `________` |
| Write call used, and its return / error | `________` | `________` |
| API read-back value | `________` | `________` |
| Watch-table in-force value, same moment | `________` | `________` |
| `QBAD` / `PASS_OUT` / value status, same moment | `________` | `________` |
| Value after holding several seconds | `________` | `________` |
...
|---|---|---|---|
| Process image assignment of the F-DI | `________` | `________` | `________` |
| Pre-/post-processing blocks registered | `________` | `________` | `________` |
| API read-back | `________` | `________` | `________` |
| Watch-table in-force value | `________` | `________` | `________` |
| `QBAD` / `PASS_OUT` / value status | `________` | `________` | `________` |
| Holds under sustained write? | `________` | `________` | `________` |
| Probe blocks deleted | — | `________` | `________` |
...
*Left blank deliberately. Nothing above may be summarised into this section by
anyone who has not run it in the tool.*

| # | Question | Verdict | Evidence (step, record row) | Date |
|---|---|---|---|---|
| Q1 | ADR 0011 D2 question (i) — does this installation's PLCSIM Advanced version and this project's safety system version support F-I/O simulation? | `________` | `________` | `________` |
| Q2 | Can an ET 200SP F-DI be configured, compiled, downloaded, with the CPU in RUN and the F-runtime group executing? | `________` | `________` | `________` |
| Q3 | Does the F-I/O reintegrate without an acknowledgement, and what do QBAD / PASS_OUT / value status actually show? | `________` | `________` | `________` |
| Q4 | ADR 0011 D2 question (ii) — can the PLCSIM Advanced API write that F-DI's channel values **by tag name**, and does the value stand? | `________` | `________` | `________` |
| Q5 | Does PIP 1 with SYNC_PI / SYNC_PO change the picture? | `________` | `________` | `________` |

**Overall verdict** (`ADR 0011 D2 primary path` / `ADR 0011 D2 fallback`):
`________`  — decided on `________` by `________`.

**Consequence recorded here, in one sentence, by the owner:** `________`
