...
- Hermes: m4-00 survey issued 2026-07-28 against the owner's local hermes-assistant checkout (owner-directed). The survey ends with the owner decision list — including the invariant-8 ruling (is a Telegram-triggered command engineering access or cell traffic?) — which must be ruled on before M4 is briefed.
