...
- m5r-09 (queued, after the m5r sweeps) — done when no live document carries
  a pre-ADR-0010 gate reference, the ADR 0010 open decisions are recorded as
  open everywhere they surface, and the tracking files reconcile against the
  full report directory.
