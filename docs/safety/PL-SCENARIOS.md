...
| **Maps to** | **AT-03 (d)**, the added two-scanner and residual observation; cross-checked by **AT-10 (a)**. *M5 note (2026-08-06, SRS m5-43 restatement): observations (a) and (d) of the validation test run at M5 as AT-03 (d-2); (b) and (c) — the monitoring case in force and the ≤ 0.3 m/s cap — defer with AT-10's landing ruling, requested in the m5-43 report. The derivation above is untouched.* |
