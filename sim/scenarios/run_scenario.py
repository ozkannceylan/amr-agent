#!/usr/bin/env python3
"""run_scenario.py - scripted M3 navigation run for the amr-agent project
(brief m3-02).

Preconditions (two other terminals, both with /opt/ros/jazzy and the
Robotnik workspace sourced):
...
- `sim/scenarios/nav_scenario.launch.py` (map_server + AMCL + NavFn + DWB +
  behaviors + bt_navigator, params `sim/scenarios/config/nav2_params.yaml`,
